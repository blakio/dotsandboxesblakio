...
const centerOfLine = (width) => ({

  0: [width * 0.068, width * 0.14], // [33.47, 61.39]
  1: [width * 0.215, width * 0.14], // [91.39, y]
  2: [width * 0.357, width * 0.14], // [149.32, y]
  3: [width * 0.495, width * 0.14], // [207.25, y]
  4: [width * 0.64, width * 0.14], // [265.17, y]
  5: [width * 0.783, width * 0.14], // [323.1, y]
  6: [width * 0.924, width * 0.14], // [381.03, y]
  7: [width * 0.068, width * .282], // [x, 120.9]
  8: [width * 0.215, width * .282],
  9: [width * 0.357, width * .282],
  10: [width * 0.495, width * .282],
  11: [width * 0.64, width * .282],
  12: [width * 0.783, width * .282],
  13: [width * 0.924, width * .282],
  14: [width * 0.068, width * 0.42], // [x, 180.41]
  15: [width * 0.215, width * 0.42],
  16: [width * 0.357, width * 0.42],
  17: [width * 0.495, width * 0.42],
  18: [width * 0.64, width * 0.42],
  19: [width * 0.783, width * 0.42],
  20: [width * 0.924, width * 0.42],
  21: [width * 0.068, width * 0.565], // [x, 239.92]
  22: [width * 0.215, width * 0.565],
  23: [width * 0.357, width * 0.565],
  24: [width * 0.495, width * 0.565],
  25: [width * 0.64, width * 0.565],
  26: [width * 0.783, width * 0.565],
  27: [width * 0.924, width * 0.565],
  28: [width * 0.068, width * 0.71], // [x, 299.42]
  29: [width * 0.215, width * 0.71],
  30: [width * 0.357, width * 0.71],
  31: [width * 0.495, width * 0.71],
  32: [width * 0.64, width * 0.71],
  33: [width * 0.783, width * 0.71],
  34: [width * 0.924, width * 0.71],
  35: [width * 0.068, width * 0.854], // [x, 358.93]
  36: [width * 0.215, width * 0.854],
  37: [width * 0.357, width * 0.854],
  38: [width * 0.495, width * 0.854],
  39: [width * 0.64, width * 0.854],
  40: [width * 0.783, width * 0.854],
  41: [width * 0.924, width * 0.854],
  42: [width * 0.14, width * 0.07], // [62.43, 31.64]
  43: [width * .282, width * 0.07], // [120.36, y]
  44: [width * 0.42, width * 0.07], // [178.28, y]
  45: [width * 0.565, width * 0.07], // [236.21, y]
  46: [width * 0.71, width * 0.07], // [294.14, y]
  47: [width * 0.854, width * 0.07], // [352.07, y]
  48: [width * 0.14, width * 0.215], // [x, 91.15]
  49: [width * .282, width * 0.215],
  50: [width * 0.42, width * 0.215],
  51: [width * 0.565, width * 0.215],
  52: [width * 0.71, width * 0.215],
  53: [width * 0.854, width * 0.215],
  54: [width * 0.14, width * 0.357], // [x, 150.65]
  55: [width * .282, width * 0.357],
  56: [width * 0.42, width * 0.357],
  57: [width * 0.565, width * 0.357],
  58: [width * 0.71, width * 0.357],
  59: [width * 0.854, width * 0.357],
  60: [width * 0.14, width * 0.495], // [x, 210.16]
  61: [width * .282, width * 0.495],
  62: [width * 0.42, width * 0.495],
  63: [width * 0.565, width * 0.495],
  64: [width * 0.71, width * 0.495],
  65: [width * 0.854, width * 0.495],
  66: [width * 0.14, width * 0.64], // [x, 269.67]
  67: [width * .282, width * 0.64],
  68: [width * 0.42, width * 0.64],
  69: [width * 0.565, width * 0.64],
  70: [width * 0.71, width * 0.64],
  71: [width * 0.854, width * 0.64],
  72: [width * 0.14, width * 0.783], // [x, 329.18]
  73: [width * .282, width * 0.783],
  74: [width * 0.42, width * 0.783],
  75: [width * 0.565, width * 0.783],
  76: [width * 0.71, width * 0.783],
  77: [width * 0.854, width * 0.783],
  78: [width * 0.14, width * 0.924], // [x, 388.69]
  79: [width * .282, width * 0.924],
  80: [width * 0.42, width * 0.924],
  81: [width * 0.565, width * 0.924],
  82: [width * 0.71, width * 0.924],
  83: [width * 0.854, width * 0.924],
